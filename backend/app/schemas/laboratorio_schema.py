...
class LaboratorioBase(BaseModel):
    ...
    tipo_laboratorio     : str            = Field(..., min_length=2, max_length=100, description="Tipo de laboratorio (Ej: Redes, Software)")
...
class LaboratorioUpdate(BaseModel):
    ...
    tipo_laboratorio     : Optional[str]  = Field(None, min_length=2, max_length=100)
